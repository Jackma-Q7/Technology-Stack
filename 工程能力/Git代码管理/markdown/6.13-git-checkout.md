...
**注意**：git checkout 命令在 Git 2.23 版本后引入了 [git switch](6.14-git-switch.md) 和 [git restore](6.15-git-restore.md) 命令，分别用于分支切换和文件恢复，以提供更清晰的语义和错误检查。如果你使用较新的 Git 版本，可以考虑使用这些命令代替 `git checkout`。
