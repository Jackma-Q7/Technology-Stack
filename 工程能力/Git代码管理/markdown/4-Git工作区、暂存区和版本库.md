...
<img src="../graph/4.png" width="680" height="365"/>
...
&emsp;&emsp;工作区是你在本地计算机上的项目目录，你在这里进行文件的创建、修改和删除操作。工作区包含了当前项目的所有文件和子目录。
...
```git
git pull origin branch-name#下载 + 自动合并到当前分支
# 或者
git fetch origin branch-name#只下载，不动你代码
...
&emsp;&emsp;通过理解工作区、暂存区和版本库的作用及其相互关系，你可以更加高效地使用 Git 进行版本控制和协同开发。