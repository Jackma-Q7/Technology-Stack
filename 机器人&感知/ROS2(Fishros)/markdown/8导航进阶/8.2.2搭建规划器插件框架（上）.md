## **8.2.2搭建规划器插件框架（上）**
新建目录 chapt8/chapt8_ws/src，然后将第7章导航的所有功能包复制到src目录下，在src 目录下创建功能包 nav2 custom planner，并为其添加nav2 core 和 pluginlib 依赖。

接着在 src/nav2 custom planner/include/nav2 custom planner 下新建nav2 custom planner.hpp
